    ...
    public class JobApplicationsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Apply([FromBody] ApplyDto dto)
        {
            ...
            if (user != null && user.SubscriptionPlan == 0)
            {
                ...
                if (appThisMonth >= 5)
                    return StatusCode(429, "Limite de candidaturas mensais atingido para o plano Free (5/mês). Faz upgrade para Pro para candidaturas ilimitadas.");
            }
            ...
            var app = new JobApplication
            {
                ...
                JobPosition = string.IsNullOrWhiteSpace(dto.JobPosition) ? null : dto.JobPosition,
